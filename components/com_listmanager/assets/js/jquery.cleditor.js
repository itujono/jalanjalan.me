...
//popupname=url
    ...
    function createPopup(popupName, options, popupTypeClass, popupContent, popupHover) {
        ...
        var $popup = $(DIV_TAG)
           ...
           // .appendTo("body");
		  //MS TWEAK. Append to content inside popup
		   .appendTo($(".panel-body"));
    ...
    function refresh(editor) {
        ...
        doc.write(
            options.docType +
            '<html>' +
            ((options.docCSSFile === '') ? '' : '<h'+'e'+'a'+'d><l'+'i'+'n'+'k rel="stylesheet" type="text/css" href="' + options.docCSSFile + '" /></h'+'e'+'a'+'d>') +
            '<b'+'o'+'d'+'y style="' + options.bodyStyle + '"></b'+'o'+'d'+'y></html>'
        );
        doc.close();
    ...
    function showPopup(editor, popup, button) {
		...
		//MS TWEAK. Place popup center screen/popup
		...
		var popleft=$(".ui-dialog").width()/2;
		var poptop=$(".ui-dialog").height()/2;
		if(popleft>0){
			left=popleft;
			top=poptop;
