...
AImporter::helper ( 'form', 'currency', 'bookpro' );
AImporter::css ( 'jbbus' );
	...
	<div class="<?php echo BookProHelper::bsrow() ?>"">
		...
		<div class="form-inline">
			<input type="checkbox" value="30" name="license_confirm"
				id='license_confirm' class="controls"> <label class="controls"
				for="term_condition"> <a
				href="index.php?option=com_content&id=<?php echo $this->config->get('term_content_id') ?>&view=article&tmpl=component&task=preview"
