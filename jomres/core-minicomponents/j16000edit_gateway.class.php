...
class j16000edit_gateway
{
    public function __construct()
    {
        ...
        $settings['notes'] = array (
            "default" => "1",
            "setting_title" => jr_gettext('_JOMRES_CUSTOMTEXT_GATEWAY_CONFIG_NOTES'.$plugin,'You must create a new API (Public and Secret Key) Credential pair in xendit, then enter those details.'),
            "setting_description" => "",
            "format" => ""
        ),
        // $settingArray=array();
        
        $settings['usesandbox'] = array (
            "default" => "1",
            "setting_title" => jr_gettext('_JOMRES_CUSTOMTEXT_GATEWAY_CONFIG_SANDBOX'.$plugin,'Use sandbox?'),
            "setting_description" => jr_gettext('_JOMRES_CUSTOMTEXT_GATEWAY_CONFIG_SANDBOX_DESC'.$plugin,'Set this to Yes if you want to use the xendit sandbox'),
            "format" => "boolean"
            ),
        $settings['public_key'] = array (
            "default" => "",
            "setting_title" => jr_gettext('_JOMRES_CUSTOMTEXT_GATEWAY_CONFIG_XENDIT_CLIENT_ID'.$plugin,'Public Key'),
            "setting_description" => "",
            "format" => "input"
            ),
        $settings['secret'] = array (
            "default" => "",
            "setting_title" => jr_gettext('_JOMRES_CUSTOMTEXT_GATEWAY_CONFIG_XENDIT_SECRET'.$plugin,'Secret'),
            "setting_description" => "",
            "format" => "input"
            ),
        $settings['public_key_sandbox'] = array (
            "default" => "",
            "setting_title" => jr_gettext('_JOMRES_CUSTOMTEXT_GATEWAY_CONFIG_XENDIT_CLIENT_ID_SANDBOX'.$plugin,'Sandbox Public Key'),
            "setting_description" => "",
            "format" => "input"
            ),  
        $settings['secret_key_sandbox'] = array (
            "default" => "",
            "setting_title" => jr_gettext('_JOMRES_CUSTOMTEXT_GATEWAY_CONFIG_XENDIT_SECRET_SANDBOX'.$plugin,'Sandbox Secret'),
            "setting_description" => "",
            "format" => "input"
            ),
        ...
        $output['NOTES'] = $settings[0]['setting_title'];
