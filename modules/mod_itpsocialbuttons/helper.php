...

{
...

    {
        ...
        $link = "https://www.facebook.com/jalanjalanme-296803280815238/";
        return '<a href="'.$link.'" title="' . JText::sprintf("MOD_ITPSOCIALBUTTONS_SUBMIT", "Facebook") . '" target="_blank" ><img src="' . $img_url . '" alt="' . JText::sprintf("MOD_ITPSOCIALBUTTONS_SUBMIT", "Facebook") . '" /></a>';
...

    {
        ...
        $link = "https://twitter.com/JalanjalanM";
        return '<a href="'.$link.'" title="' . JText::sprintf("MOD_ITPSOCIALBUTTONS_SUBMIT", "Twitter") . '" target="_blank" ><img src="' . $img_url . '" alt="' . JText::sprintf("MOD_ITPSOCIALBUTTONS_SUBMIT", "Twitter") . '" /></a>';
