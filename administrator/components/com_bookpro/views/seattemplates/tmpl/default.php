		...
		<table class="table" >
			<thead>
				<tr>
					...
					<th width="4%">
				        <?php echo JHTML::_('grid.sort', 'ID', 'id', null, null); ?>
					</th>
				...
				<?php } else { ?>
				    <?php for ($i = 0; $i < $itemsCount; $i++) { ?>
				    	...
				    	<tr>
				    		...
				    		<td><a href="<?php echo JRoute::_('index.php?option=com_bookpro&task=seattemplate.edit&id='.$subject->id);?>"><?php echo $subject->title; ?>
				    		(<?php echo BusHelper::getTotalSeat($subject->block_layout) ?>)
				    		</a></td>
