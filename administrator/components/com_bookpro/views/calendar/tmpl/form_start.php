...
$modallink= JURI::root().'administrator/index.php?option=com_bookpro&view=calendar&tmpl=component&layout=default&start='.$this->start;
...
<div class="blank">
<a class="modal" href="<?php echo $modallink ?>" rel="{handler: 'iframe', size: {x: 600, y: 550}}"><?php echo JText::_("Edit Departure date")?></a>
</div>
</div></td>
</tr>
<tr>
