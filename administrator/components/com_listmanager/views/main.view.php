...
class HelperListmanagerView extends JViewLegacy {
	...
	function __getCSS(){
		...
		$ret[]=JURI::base().'components/com_listmanager/assets/css/ms-theme/jquery-ui-1.9.2.custom.css';
		return $ret;		
	}
	...
	function __getJS(){
		...
		//if (version_compare($version->getShortVersion(), '3.0.0') < 0){			
			...
			//$ret[]=JURI::base().'components/com_listmanager/assets/js/jquery-1.9.0.js';									
			$ret[]=JURI::base().'components/com_listmanager/assets/js/jquery-ui-1.9.2.custom.min.js';
