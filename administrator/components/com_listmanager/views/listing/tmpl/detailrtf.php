...
<div class="cb_table_wrapper">	
	<div class="form-horizontal">	
		<div class="control-group">
			...
			<div class="controls">		
			  <input type="file" id="detailrtf" name="detailrtf">
		      <?php if (!is_null($item)&&isset($item['detailrtf'])):?>
		      <label><h4><?php echo JText::_('RTF_FILE_UPLOADED');?></h4><a href="<?php echo JURI::root().DS."media".DS.'com_calcbuilder'.DS.$item['detailrtf'];?>"> <?php echo $item['detailrtf'];?></a></label>
		      <?php endif;?>		
			</div>
		</div>
		<div class="control-group">
			<label class="control-label"></label>
			<div class="controls"><h4><?php echo JText::_("LM_RTF_VARIABLES")?></h4></div>
		</div>
		<div class="control-group">
			<label class="control-label"></label>
			<div class="controls">		
...
<input type="hidden" name="task" value="storeDetailRTF" />
