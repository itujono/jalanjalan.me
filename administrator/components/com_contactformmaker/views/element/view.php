...
class contactformmakerViewElement extends JViewLegacy
{
...
function tableOrdering( order, dir, task ) {
    ...
    submitform( task );
		...
		<form action="index.php?option=com_contactformmaker&amp;task=element&amp;tmpl=component&amp;object=id" method="post"  id="adminForm" name="adminForm">
