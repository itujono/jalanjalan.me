...
<div id="editcell">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
            	<input type="text"  name="desc" size="50" value="<?php echo $this->item['desc'];?>" />
            </td>
        </tr>         
        <tr>
            <th>
            ...
            <td>
				...
				echo $editor->display('contentoption', $this->item['content'], '100%','400','100','6');
				?> 
            </td>                        
        </tr>
        <tr>
            ...
            <td>
            	<input type="text"  name="value" size="50" value="<?php echo $this->item['value'];?>" />
            </td>
        </tr>
    </tbody>
 	</table>    
...
<input type="hidden" name="idoption" value="<?php echo $this->item['id'];?>" />
</form>